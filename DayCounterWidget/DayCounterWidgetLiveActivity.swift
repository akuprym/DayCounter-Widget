...
struct DayCounterWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = DayCounterWidgetAttributes(name: "Me")
    static let contentState = DayCounterWidgetAttributes.ContentState(value: 3)
